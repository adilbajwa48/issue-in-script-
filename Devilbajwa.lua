...
local KEY_URL = "https://raw.githubusercontent.com/adilbajwa48/Key.txt/main/key.txt"
...
function getKey()
    ...
    return r.content:gsub("%s+", "")
end

local input = gg.prompt({"ENTER KEY"}, nil, {"text"})

if not input then
    os.exit()
end

local onlineKey = getKey()

if input[1] == onlineKey then
...
--╚═══════════════════════════════════════════════════════════════════╝
-- 👑 OWNER INFO
local OWNER = "👑 OWNER :  Adil Bajwa"
local YT = "📺 YOUTUBE : @adilbajwa1170"
local DISCORD = "💬 DISCORD : @adilbajwa03"
function toggleGodMode()
    if gm4 == "❌" then
        gg.clearResults()
        gg.searchNumber("100;1;50", gg.TYPE_FLOAT)
...
function toggleSpeed()
    if shv222 == "❌" then
        gg.clearResults()
        gg.searchNumber("1;35;443", gg.TYPE_FLOAT)
...
function toggleWallhack()
    if walg == "❌" then
        gg.clearResults()
        gg.searchNumber("2;100;50", gg.TYPE_FLOAT)
...
function toggleFastKill()
    if fastkil == "❌" then
        gg.clearResults()
        gg.searchNumber("1;1;1;1", gg.TYPE_FLOAT)
        gg.getResults(50)
        gg.editAll("9999", gg.TYPE_FLOAT)

        fastkil = "✅"
        gg.toast("⚡ FAST KILL ON")
        gg.clearResults()
...
function playerMenu()
    ...
    elseif choice == 9 then toggleHighJump()
...
function teleportByMarker()
    ...
    while true do
        ...
        local s = gg.choice(menu, nil, "SELECT MARKER")
...
--╚═══════════════════════════════════════════════════════════════════╝
---- 👑 OWNER INFO
local OWNER = "👑 OWNER : Muhammad Adil"
local YT = "📺 YOUTUBE : @adilbajwa1170"
local DISCORD = "💬 DISCORD : adilbajwa03"
...
"💬 DISCORD",
"❌ EXIT"
}, nil, "👑 ADIL BAJWA VIP MENU 👑")

if menu == 1 then
mainMenu()

elseif menu == 2 then
os.execute("am start https://youtube.com/@adilbajwa1170")

elseif menu == 3 then
gg.copyText("adilbajwa03")
gg.alert("Discord Copied")
...
function mainMenu()
    ...
    elseif menu == 2 then
        gg.alert("VEHICLE MENU READY")

    elseif menu == 3 then
        gg.alert("WORLD MENU READY")

    elseif menu == 4 then
        gg.alert("VISUAL MENU READY")

    elseif menu == 5 then
        tpMenu()

    elseif menu == 6 then
        gg.alert("AIMBOT READY")
